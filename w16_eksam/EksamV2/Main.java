...
public class Main extends JPanel implements WindowListener{
    ...
    private static ImageIcon showImage = new ImageIcon(tri.generate(Side, Side, Side, R));
    ...
    private class IncrementButton implements ActionListener{
        ...
        public void actionPerformed(ActionEvent e) {
            R ++;
            showImage = new ImageIcon(tri.generate(Side, Side, Side, R));
            pilt.setText("Samm " +R);
            pilt.setIcon(showImage);
            add(pilt);       
        }
    ...
    private class PrintButton implements ActionListener{
        ...
        public void actionPerformed(ActionEvent e) {
            try{
                ImageIO.write(tri.generate(Side, Side, Side, R), "png", new File("pilt.png"));
            }   catch (Exception exc){
                exc.printStackTrace();
            }    
        }
